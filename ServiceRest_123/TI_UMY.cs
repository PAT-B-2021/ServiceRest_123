...
namespace ServiceRest_123
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=LAPTOP-D0HHMR6E;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=LAPTOP-D0HHMR6E;Initial Catalog=\"TI UMY\";Persist Security Info=True;User ID=sa;Password=123");
